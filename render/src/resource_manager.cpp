...
const fpath ResourceManager::material_path	 = fpath(PROJECT_ROOT_PATH) / "asset/material";
const fpath ResourceManager::shader_path	 = fpath(PROJECT_ROOT_PATH) / "asset/shader";
const fpath ResourceManager::mesh_path		 = fpath(PROJECT_ROOT_PATH) / "asset/mesh";
const fpath ResourceManager::scene_path		 = fpath(PROJECT_ROOT_PATH) / "asset/scene";
const fpath ResourceManager::simulation_path = fpath(PROJECT_ROOT_PATH) / "asset/simulation";
