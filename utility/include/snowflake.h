...
typedef int64_t Snowflake_type;
constexpr Snowflake_type SNOWFLAKE_INVALID = 0;
...
class Snowflake
{
    ...
    static constexpr int64_t TWEPOCH = 1672502400L; // 2023.1.1 00:00:00
...
public:
    ...
    int64_t nextid(int64_t workerid = 0L, int64_t datacenterid = 0L)
    {
